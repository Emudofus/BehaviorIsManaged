package flashx.textLayout.compose
{
    ...
    public class BaseCompose extends Object
    {
        ...
        {
            var _loc_3:FlowElement = null;
            var _loc_4:Boolean = false;
            var _loc_8:ParagraphElement = null;
            ...
            var _loc_15:ListItemElement = null;
            var _loc_5:int = 0;
        ...
        {
            var _loc_10:int = 0;
            var _loc_11:FloatCompositionData = null;
            var _loc_12:InlineGraphicElement = null;
        ...
        {
            var _loc_3:int = 0;
            var _loc_4:FlowLeafElement = null;
            var _loc_5:Number = NaN;
            var _loc_6:Number = NaN;
            var _loc_7:ContainerController = null;
            var _loc_8:int = 0;
            var _loc_9:FloatCompositionData = null;
        ...
        protected function composeParagraphElementIntoLines() : Boolean
        {
            ...
            var _loc_10:AlignData = null;
            var _loc_11:Number = NaN;
            var _loc_12:Number = NaN;
            var _loc_13:int = 0;
            var _loc_14:FlowElement = null;
        ...
        {
            var _loc_5:InlineGraphicElement = null;
            if (!this._curParcel)
            {
                return false;
            }
        ...
        protected function processFloatsAtLineStart() : void
        {
            var _loc_1:int = 0;
            var _loc_2:int = 0;
            var _loc_3:FlowLeafElement = null;
            if (this._forceILGs)
            {
                return;
            }
        ...
        protected function processFloatsAtLineEnd(param1:TextLine) : Boolean
        {
            ...
            var _loc_11:Number = NaN;
            var _loc_12:FloatCompositionData = null;
            var _loc_13:Number = NaN;
            var _loc_14:InlineGraphicElement = null;
        ...
        {
            var _loc_4:ITextLayoutFormat = null;
        ...
        protected function finishComposeLine(param1:TextLine, param2:TextLine) : void
        {
            var _loc_4:Number = NaN;
            var _loc_5:Number = NaN;
            var _loc_9:ITextLayoutFormat = null;
            var _loc_10:Object = null;
            var _loc_11:String = null;
            var _loc_12:LeadingAdjustment = null;
            var _loc_13:Number = NaN;
            var _loc_14:Boolean = false;
            var _loc_15:Boolean = false;
            var _loc_16:FlowLeafElement = null;
            var _loc_17:LeadingAdjustment = null;
        ...
        {
            var _loc_3:ContainerController = null;
        ...
        private function getLineAdjustmentForInline(param1:TextLine, param2:String, param3:Boolean) : LeadingAdjustment
        {
            ...
            var _loc_12:LeadingAdjustment = null;
            var _loc_13:Number = NaN;
            var _loc_4:LeadingAdjustment = null;
