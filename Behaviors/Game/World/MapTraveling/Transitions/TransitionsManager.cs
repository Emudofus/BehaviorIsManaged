...
namespace BiM.Behaviors.Game.World.MapTraveling.Transitions
{
    ...
    {
        private Dictionary<int, Func<SubMapTransition>> m_transitionsCreators = new Dictionary<int, Func<SubMapTransition>>(); 
        ...
        {
            var identifer = reader.ReadInt32();
            ...
            var transition = m_transitionsCreators[identifer]();
